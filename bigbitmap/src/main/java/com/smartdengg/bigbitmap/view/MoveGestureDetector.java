...
public class MoveGestureDetector extends BaseGestureDetector {
  ...
  @Override protected void handleInProgressEvent(MotionEvent event) {
  ...
  @Override protected void handleStartProgressEvent(MotionEvent event) {
    int actionCode = event.getAction() & MotionEvent.ACTION_MASK;
    switch (actionCode) {
  ...
  public static class SimpleMoveGestureDetector implements OnMoveGestureListener {
    ...
    @Override public boolean onMoveBegin(MoveGestureDetector detector) {
      return true;
    }
    ...
    @Override public void onMoveEnd(MoveGestureDetector detector) {
    }
  }
}
