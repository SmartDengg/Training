 ...
 * provided by the <code>java.util.concurrent</code> pacakge such as {@link
...
public abstract class AsyncTask<Params, Progress, Result> {
  ...
  @TargetApi(11) private static class SerialExecutor implements Executor {
   ...
   * @see #doInBackground
   */
  @SuppressWarnings({ "UnusedDeclaration" }) protected void onProgressUpdate(Progress... values) {
  }
   ...
   * @see #isCancelled()
   */
  @SuppressWarnings({ "UnusedParameters" }) protected void onCancelled(Result result) {
    onCancelled();
  }
  ...
  @SuppressWarnings({ "RawUseOfParameterizedType" }) private static class AsyncTaskResult<Data> {
