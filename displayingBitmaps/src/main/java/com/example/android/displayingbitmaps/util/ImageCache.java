 ...
 * {@link ImageCache#getInstance(android.support.v4.app.FragmentManager, ImageCacheParams)} to get
 * an instance of this
...
public class ImageCache {
   ...
   * {@link ImageCache#getInstance(android.support.v4.app.FragmentManager, ImageCacheParams)} to
   * fetch an ImageCache
   * instance.
   *
  ...
  private void init(ImageCacheParams cacheParams) {
    ...
    if (mCacheParams.memoryCacheEnabled) {
      ...
      mMemoryCache = new LruCache<String, BitmapDrawable>(mCacheParams.memCacheSize) {
         ...
         */
        @Override protected void entryRemoved(boolean evicted, String key, BitmapDrawable oldValue,
   ...
   */
  @TargetApi(VERSION_CODES.KITKAT) private static boolean canUseForInBitmap(Bitmap candidate,
   ...
   */
  @TargetApi(VERSION_CODES.KITKAT) public static int getBitmapSize(BitmapDrawable value) {
   ...
   * otherwise.
   */
  @TargetApi(VERSION_CODES.GINGERBREAD) public static boolean isExternalStorageRemovable() {
   ...
   */
  @TargetApi(VERSION_CODES.FROYO) public static File getExternalCacheDir(Context context) {
    if (Utils.hasFroyo()) {
   ...
   */
  @TargetApi(VERSION_CODES.GINGERBREAD) public static long getUsableSpace(File path) {
    if (Utils.hasGingerbread()) {
